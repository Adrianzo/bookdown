...
We have defined a few types of blocks for this book to show notes, tips, and warnings, etc. Below are some examples, of type: `rmdnote`, `rmdcaution`, `rmdimportant`, `rmdtip` and `rmdwarning`.
